...
pub type GateMap = IndexMap<String, PropsMap, RandomState>;
pub type PropsMap = NullableIndexMap<Qargs, Option<InstructionProperties>>;
pub type GateMapState = Vec<(String, Vec<(Option<Qargs>, Option<InstructionProperties>)>)>;
...
impl Index<&str> for Target {
    ...
    fn index(&self, index: &str) -> &PropsMap {
